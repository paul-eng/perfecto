...
var elementScrollBy = function (elememt, options) {
  ...
  return elementScroll(
    elememt,
    __assign({}, options, { left: left, top: top })
  );
};
...
var toPhysicalAlignment = function (
  options,
  axis,
...
var elementScrollIntoView = function (element, options) {
  ...
  var frames = [];
  for (
    var cursor = parentElement(element);
    cursor !== null;
  ...
  var _loop_1 = function (frame) {
    ...
    if (scrollingElement === frame) {
      ...
      actions.push(function () {
        return windowScroll(
          __assign({}, options, { top: blockScroll, left: inlineScroll })
        );
      });
    } else {
      ...
      switch (alignY) {
        ...
        case 1 /* AlignCenterAlways */: {
          blockScroll =
            targetBlock - (top_1 + height / 2) + scrollbarHeight / 2;
          break;
        }
        case 0 /* AlignToEdgeIfNeeded */: {
          blockScroll = alignNearest(
  ...
  try {
    ...
    try {
      if (frames_1_1 && !frames_1_1.done && (_a = frames_1.return))
        _a.call(frames_1);
    } finally {
